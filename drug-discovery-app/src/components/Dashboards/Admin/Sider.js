  ...
  const navItems = [
    {
      ...
      label: <Link href="/Dashboard/Admin/dashboard">Dashboard</Link>,
    },
    {
      key: 'users',
      icon: <UserOutlined />,
    ...
    },
    {
      ...
      label: <Link href="/Dashboard/Admin/molecular-model">Molecular Models</Link>,
    },
    {
      key: 'simulations',
      icon: <ExperimentOutlined />,
      label: <Link href="/Dashboard/Admin/simulation">Simulations</Link>,
    },
    {
      key: 'data-export',
      icon: <ExportOutlined />,
      label: <Link href="/Dashboard/Admin/data-export">Data Export</Link>,
    },
    {
      key: 'visualization',
      icon: <BarChartOutlined />,
      label: <Link href="/Dashboard/Admin/visualization">Visualization</Link>,
    },
  ];
