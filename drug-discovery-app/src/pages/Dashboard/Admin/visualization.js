...
const VisualizationPage = () => {
  ...
  const fetchModelsAndSimulations = async () => {
    try {
      ...
      message.error('Failed to load visualization options');
    }
  };
  ...
  const fetchModelData = async (modelId) => {
    ...
    try {
      ...
      message.error('Failed to load model visualization data');
    } finally {
      setLoading(false);
    }
  };
  ...
  const fetchTrajectoryData = async (simulationId) => {
    ...
    try {
      ...
      message.error('Failed to load trajectory visualization data');
    } finally {
      setLoading(false);
    }
  };
